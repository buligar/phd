...
sampling_frequency = 200  # Гц (100 - чтобы увидеть частоты 0-40, 200 чтобы увидеть частоты 0-80)
...
rate2_array[:int(5*fs)] = 160*Hz
#   - в интервале t=[5,10) сек: rate1=60 Гц, rate2=10 Гц
rate1_array[int(5*fs):] = 160*Hz
...
win_len, step, order = 32, 16, 4
nfft    = 256                   # более тонкая сетка
