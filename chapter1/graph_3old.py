...
if __name__ == "__main__":
    ...
    plot_3d_with_significance(
        stats_csvs=[
            "results_ext_test1_one_cluster_bez_boost/avg_tests_avg_spikes_5000ms.csv",
            "results_ext_test1_random_neighbors_bez_boost/avg_tests_avg_spikes_5000ms.csv"
        ],
        pvals_csv="results/one_random_without_boost/mannwhitney_one_random_without_boost_all.csv",
        labels=["one_cluster_bez_boost", "random_neighbors_bez_boost"],
        ...
        max_rate=4,
        I0_value_filter=1000,
        output_pdf="results/3D_one_bez_boost_vs_random_bez_boost_with_std.pdf"
    )

    # Сравнение one_cluster_s_boost vs random_neighbors_s_boost
    plot_3d_with_significance(
        stats_csvs=[
            "results_ext_test1_one_cluster_s_boost/avg_tests_avg_spikes_5000ms.csv",
            "results_ext_test1_random_neighbors_s_boost/avg_tests_avg_spikes_5000ms.csv"
        ],
        pvals_csv="results/one_random_with_boost/mannwhitney_one_random_with_boost_all.csv",
        labels=["one_cluster_s_boost", "random_neighbors_s_boost"],
        colormap_names=["magma", "magma"],
        alphas_meas=[1, 0.5],
        alphas_rand=[1, 1],
        p_input_values=np.arange(0.1, 0.21, 0.05),
